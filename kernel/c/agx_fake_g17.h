...
enum vinix_fake_g17_render_resource_field {
    ...
    VINIX_FAKE_G17_RESOURCE_VERTEX_HELPER_PROGRAM = 22,
    VINIX_FAKE_G17_RESOURCE_FRAGMENT_HELPER_PROGRAM = 23,
    VINIX_FAKE_G17_RESOURCE_LOAD_PIPELINE = 24,
    VINIX_FAKE_G17_RESOURCE_STORE_PIPELINE = 25,
    VINIX_FAKE_G17_RESOURCE_PARTIAL_RELOAD_PIPELINE = 26,
    VINIX_FAKE_G17_RESOURCE_PARTIAL_STORE_PIPELINE = 27,
    VINIX_FAKE_G17_RESOURCE_FIELD_COUNT = 28,
};
