...
// stubs cannot silently override durability, shutdown, or hardened I/O entry
// points.
pub fn init_storage_syscalls() {
	syscall_table[63] = voidptr(fs.syscall_read_checked)
	syscall_table[64] = voidptr(fs.syscall_write_checked)
