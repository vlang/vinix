...
class ProtocolTests(unittest.TestCase):
    ...
    def test_source_integration_contract(self):
        ...
        self.assertIn('z.zone_element_resolve_from(z.full, addr)', zone)
        self.assertIn('z.zone_element_resolve_from(z.partial, addr)', zone)
        self.assertIn('z.zone_element_resolve_from(z.empty, addr)', zone)
        self.assertNotIn('heads := [z.full, z.partial, z.empty]!', zone)
