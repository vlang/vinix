...
read map, its fixed address-space prefix, G17 no-op CSC allocation, and two
static color-matrix banks, the G17C PIO relative-offset table and its 12 primary-aperture
